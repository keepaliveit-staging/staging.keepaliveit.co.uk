/*! PushyDrawer - v1 - 2020-10-20
* PushyDrawer is a fork of Pushy by Christopher Yee.
* PushyDrawer supports dynamic DOM appended calls, unlike the original version.
* by Joel Murphy <joel@keepaliveit.co.uk> */
...
(function ($) {
    $.fn.mobileMenu = function (options) {
        // Add default settings in a future version
        //var defaults = {};
        //var settings = $.extend({}, defaults, options);

        if (this.length > 1) {
            this.each(function () {
                $(this).mobileMenu(options)
            });
            return this;
        }
        ...
        this.initialize = function () {
            ...
            //checks if 3d browser transforms support
