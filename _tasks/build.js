...
const buildJekyll = () => {
  return utils.runCommand('jekyll build --config _config.yml');
};
...
const buildJekyllTest = () => {
  return utils.runCommand('jekyll build --future --config _config.yml,_config-test.yml');
};
...
const buildJekyllLocal = () => {
  return utils.runCommand('jekyll build --future --config _config.yml,_config-test.yml,_config-dev.yml');
};
